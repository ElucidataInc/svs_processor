...
class PNGConverter:
    def __init__(self, svs_file_path, png_output_dir):
    ...
    def convert_all_levels(self):
        ...
        try:
            ...
            for level in range(num_levels):
                ...
                output_png = os.path.join(self.png_output_dir, f"{os.path.splitext(os.path.basename(self.svs_file_path))[0]}_level_{level}.png")
